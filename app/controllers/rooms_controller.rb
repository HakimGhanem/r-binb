...
before_action :require_same_user, only: [:edit, :update]
    ...
    def create
          ...
          if @room.save
                ...
                @photos = @room.photos
                redirect_to edit_room_path(@room), notice:"Votre annonce a été ajoutée avec succès" #redirige vers la page de l’annonce et notifie l’utilisateur de la réussite de la création
